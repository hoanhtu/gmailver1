...
import anhtu.com.vn.gmailAPI.helper.InternetDetector;
import anhtu.com.vn.gmailAPI.helper.Utils;

import static anhtu.com.vn.gmailAPI.helper.GmailAPI.PREF_ACCOUNT_NAME;
import static anhtu.com.vn.gmailAPI.helper.GmailAPI.mCredential;

public class NewMailActivity extends AppCompatActivity {
    private EditText toEdt, fromEdt, subEdt, contentEdt, edtAttachmentData;
    private Toolbar toolbar;
    private Button sendFabButton;
...
//                .setBackOff(new ExponentialBackOff());
        ...
        findViewById(R.id.attach_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (Utils.checkPermission(getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                    ...
                    ActivityCompat.requestPermissions(NewMailActivity.this,
    ...
    private void findView() {
        toEdt = findViewById(R.id.toEditText);
        fromEdt = findViewById(R.id.fromEditText);
        subEdt = findViewById(R.id.subjectEditText);
        contentEdt = findViewById(R.id.contentNewMailEditText);
        edtAttachmentData = findViewById(R.id.attachmentData);
        sendFabButton = findViewById(R.id.action_send);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_send) {
            ...
            View view = findViewById(R.id.action_send);
            getResultsFromApi(view);

            Toast.makeText(getBaseContext(),"Send success",Toast.LENGTH_LONG).show();
            finish();
            return true;
        }
    ...
    private void getResultsFromApi(View view) {
        ...
        } else if (!Utils.isNotEmpty(toEdt)) {
            showMessage(view, "To address Required");
        } else if (!Utils.isNotEmpty(subEdt)) {
            showMessage(view, "Subject Required");
        } else if (!Utils.isNotEmpty(contentEdt)) {
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, String> {
        ...
        private View view = findViewById(R.id.action_send);
        private NewMailActivity activity;

        MakeRequestTask(NewMailActivity activity, GoogleAccountCredential credential) {
        ...
        private String getDataFromApi() throws IOException {
            ...
            String user = "me";
            String to = Utils.getString(toEdt);
            String from = mCredential.getSelectedAccountName();
            String subject = Utils.getString(subEdt);
            String body = Utils.getString(contentEdt);
        ...
        private String sendMessage(Gmail service,
            ...
            //Toast.makeText(getBaseContext(),"Message id: " + message.getId(),Toast.LENGTH_SHORT).show();
            //Toast.makeText(getBaseContext(),message.toPrettyString(),Toast.LENGTH_SHORT).show();
        ...
        private MimeMessage createEmail(String to,
            ...
            if (!(activity.fileName.equals(""))) {
                ...
                attachmentBody.setFileName(temp[temp.length-1]);
